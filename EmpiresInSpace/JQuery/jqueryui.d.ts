...
declare module JQueryUI {
    ...
    interface SelectmenuEvents {
        change?(event: Event, ui: any): void;
        close?(event: Event, ui: { selecting?: Element; }): void;
        create?(event: Event, ui: any): void;
        focus?(event: Event, ui: any): void;
        open?(event: Event, ui: { unselected: Element; }): void;
        select?(event: Event, ui: { unselecting: Element; }): void;
    }
...
interface JQuery {
    ...
    draggable(options: JQueryUI.DraggableOptions | JQueryUI.DraggableEvents): JQuery;
    ...
    droppable(options: JQueryUI.DroppableOptions | JQueryUI.DroppableEvents): JQuery;
    ...
    resizable(options: JQueryUI.ResizableOptions | JQueryUI.ResizableEvents): JQuery;
    ...
    selectmenu(): JQuery;
    selectmenu(options: JQueryUI.SelectableOptions): JQuery;
    selectmenu(optionLiteral: string): JQuery;
    selectmenu(optionLiteral: string, options: JQueryUI.SelectableOptions): JQuery;
    selectmenu(events: JQueryUI.SelectmenuEvents): JQuery;
    selectmenu(options: JQueryUI.SelectmenuOptions | JQueryUI.SelectmenuEvents): JQuery;
    ...
    sortable(options: JQueryUI.SortableOptions | JQueryUI.SortableUIParams | JQueryUI.SortableEvents): JQuery;
    ...
    tabs(options: JQueryUI.TabsOptions | JQueryUI.TabsEvents): JQuery;
