...
var Keymap = /** @class */ (function () {
    function Keymap(bindings) {
        ...
        if (bindings) { // Copy initial bindings into it
            for (var bindingName in bindings)
                this.bind(bindingName, bindings[bindingName]);
        }
    }
    ...
    Keymap.prototype.install = function (element) {
        ...
        var keymap = this;
        function handler(event) { if (keymap.isActive)
            return mainObject.keymap.dispatch(event, element);
        else
            return true; }
        // Now install it
    ...
    Keymap.prototype.dispatch = function (event, element) {
        ...
        // Otherwise, use the keyCode property and the code-to-name map below
            ...
            keyname = mainObject.keymap.keyCodeToKeyName[event.keyCode];
        console.log(keyname);
        ...
        if (handler) { // If there is a handler for this key, handle it
            ...
            if (retval === false) {
                if (event.stopPropagation)
                    event.stopPropagation(); // DOM model
                else
    ...
    Keymap.prototype.normalize = function (keyid) {
