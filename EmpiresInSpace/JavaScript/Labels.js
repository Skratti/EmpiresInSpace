...
(function (i18n) {
    ...
    i18n.setLabels = setLabels;
    //get a sql label
    function label(labelId) {
        if (i18n.sqlLabels[mainObject.user.languageId] == undefined)
            return 'LANGUAGE NOT LOADED YET';
        if (i18n.sqlLabels[mainObject.user.languageId][labelId] == undefined)
            return 'LABEL NOT FOUND';
        return i18n.sqlLabels[mainObject.user.languageId][labelId];
    }
    i18n.label = label;
    function languageAdd(XMLlanguages) {
        ...
        for (var i = 0; i < XMLAllLabels.length; i++) {
            ...
            for (var j = 0; j < Labels.length; j++) {
                ...
                if (i18n.sqlLabels[languageId] == undefined)
                    i18n.sqlLabels[languageId] = [];
                i18n.sqlLabels[languageId][labelId] = labelValue;
            }
