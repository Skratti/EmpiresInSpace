...
module TilemapModule
{
    ...
    export class ColonyMap extends Tilemap {
        ...
        makeColonyArea(planetArea: StarData | PlanetData): ColonyArea {
            ...
            */
            ...
            var ColonyArea : ColonyArea = { Id: planetArea.Id, AreaOffset: AreaOffset, PlanetArea: <any>planetArea, BackGroundSize: BackGroundSize, BackGroundOffset: BackGroundOffset};
        ...
        findCreatePlanetTile(_colRow: ColRow, planetArea: StarData | PlanetData): Tile {
