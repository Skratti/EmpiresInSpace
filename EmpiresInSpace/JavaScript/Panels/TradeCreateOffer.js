...
(function (TradeOffersModule) {
    ...
    (function (TransferAmount) {
        TransferAmount[TransferAmount["One"] = 1] = "One";
        TransferAmount[TransferAmount["Ten"] = 10] = "Ten";
        TransferAmount[TransferAmount["Hundred"] = 100] = "Hundred";
        TransferAmount[TransferAmount["Thousand"] = 1000] = "Thousand";
    })(TransferAmount = TradeOffersModule.TransferAmount || (TradeOffersModule.TransferAmount = {}));
    var DemandGoodType;
    (function (DemandGoodType) {
        DemandGoodType[DemandGoodType["R"] = 0] = "R";
        DemandGoodType[DemandGoodType["I"] = 1] = "I";
        DemandGoodType[DemandGoodType["II"] = 2] = "II";
        DemandGoodType[DemandGoodType["III"] = 3] = "III";
        DemandGoodType[DemandGoodType["SI"] = 4] = "SI";
        DemandGoodType[DemandGoodType["SII"] = 5] = "SII";
    })(DemandGoodType = TradeOffersModule.DemandGoodType || (TradeOffersModule.DemandGoodType = {}));
    ...
    TradeOffersModule.PopulateCreateTradeForm = PopulateCreateTradeForm;
    var CreateTrade = /** @class */ (function () {
        ...
        CreateTrade.prototype.PendingTransfer = function (goodId) {
            if (this.OfferedGoods.length <= goodId)
                return 0;
            if (this.OfferedGoods[goodId])
                return this.OfferedGoods[goodId];
            return 0;
        };
        CreateTrade.prototype.CargoChange = function (spaceObject) {
            var goodsCount = 0;
        ...
        CreateTrade.prototype.SetSelectedTransferAmount = function (newValue) {
        ...
        CreateTrade.prototype.SetSelectedDemandGoodType = function (newValue) {
        ...
        CreateTrade.prototype.ClearClick = function () {
            this.OfferedGoods = [];
            this.DemandedGoods = [];
        ...
        CreateTrade.prototype.OfferGoodClick = function (goodId, addToOffer) {
            ...
            if (addToOffer) {
                if (ToTransfer > this.GoodsLeftForTrade[goodId])
                    ToTransfer = this.GoodsLeftForTrade[goodId];
            }
            /*
            ...
            */
            ...
            if (this.OfferedGoods[goodId] == null || this.OfferedGoods[goodId] == 0)
                ...
                this.OfferedGoods[goodId] += ToTransfer;
            if (this.OfferedGoods[goodId] > 9999)
                this.OfferedGoods[goodId] = 9999;
            if (this.OfferedGoods[goodId] < 0)
                this.OfferedGoods[goodId] = 0;
            this.RefreshOfferSection();
            this.RefreshTradeSelectedShip();
        };
        CreateTrade.prototype.DemandGoodClick = function (goodId, addToDemand) {
        ...
        CreateTrade.prototype.CreateTradeClick = function () {
        ...
        CreateTrade.prototype.SwitchSelectedShip = function (spaceObject) {
            //if (this.HasChanges) this.SendChanges();
            this.OfferedGoods = [];
            this.DemandedGoods = [];
            this.TradingShip = spaceObject;
        ...
        CreateTrade.prototype.RefreshTradeOwnShips = function () {
            ...
            for (var i = 0; i < mainObject.ships.length; i++) {
                ...
                if (!mainObject.ships[i].isOnCommNodeTile())
                    continue;
                //omit ships that have bo goods on board? 
                if (mainObject.ships[i].cargoHoldUsed() == 0)
                    continue;
        ...
        //ship name, cargo bar and cargo of selected ship
        CreateTrade.prototype.RefreshTradeSelectedShip = function () {
            ...
            for (var currentGoodsIndex = 0; currentGoodsIndex < mainObject.goods.length; currentGoodsIndex++) {
                if (!this.TradingShip.goods[currentGoodsIndex])
                    continue;
            ...
            for (var i = 0; i < TradeOffersModule.tradeOffers.length; i++) {
                if (!TradeOffersModule.tradeOffers[i])
                    continue;
                if (TradeOffersModule.tradeOffers[i].objectType != 0 || TradeOffersModule.tradeOffers[i].creatorId != this.TradingShip.id)
                    continue;
        ...
        //trade area buttons with transfer amount labels, one+ row with offer, one+row with demand
        CreateTrade.prototype.RefreshTradeTradeArea = function () {
            /*
        ...
        CreateTrade.prototype.RefreshOfferSection = function () {
        ...
        CreateTrade.prototype.BindShipListShipClick = function (spaceObject, shipDiv) {
            shipDiv.bind("mousedown touchstart", function (e) { e.stopPropagation(); TradeOffersModule.TradeCreatePanel.SwitchSelectedShip(spaceObject); });
        };
        CreateTrade.prototype.BindOfferGoodClick = function (goodId, div, addToDemand) {
            div.bind("mousedown touchstart", function (e) { e.stopPropagation(); TradeOffersModule.TradeCreatePanel.OfferGoodClick(goodId, addToDemand); });
        };
        CreateTrade.prototype.BindDemandGoodClick = function (goodId, div, addToDemand) {
            div.bind("mousedown touchstart", function (e) { e.stopPropagation(); TradeOffersModule.TradeCreatePanel.DemandGoodClick(goodId, addToDemand); });
        };
        CreateTrade.prototype.RefreshDemandSection = function () {
            //empty and construct the goods area:
        ...
        //goods selector page
        CreateTrade.prototype.RefreshTradeGoodsSelect = function () {
            ...
            for (var i = 0; i < mainObject.goods.length; i++) {
                ...
                if (this.SelectedDemandGoodType == DemandGoodType.R) {
                    ...
                    if (!Shipmodule)
                        continue;
                    if (this.SelectedDemandGoodType == DemandGoodType.I && Shipmodule.level != 1)
                        continue;
                    if (this.SelectedDemandGoodType == DemandGoodType.II && Shipmodule.level != 2)
                        continue;
                    if (this.SelectedDemandGoodType == DemandGoodType.III && Shipmodule.level != 3)
                        continue;
                    if (this.SelectedDemandGoodType == DemandGoodType.SI && Shipmodule.level != 4)
                        continue;
                    if (this.SelectedDemandGoodType == DemandGoodType.SII && Shipmodule.level != 5)
                        continue;
        ...
        CreateTrade.prototype.showCreateTrade = function () {
    ...
    TradeOffersModule.CreateTrade = CreateTrade;
    TradeOffersModule.TradeCreatePanel = new CreateTrade();
})(TradeOffersModule || (TradeOffersModule = {}));
//# sourceMappingURL=TradeCreateOffer.js.map