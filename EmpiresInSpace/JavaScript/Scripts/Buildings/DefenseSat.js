...
var Scripts;
(function (Scripts) {
    var DefSat = /** @class */ (function (_super) {
        __extends(DefSat, _super);
        function DefSat() {
            var _this = 
            //call super, set scriptType to 1 (Building) and Id to 21 (Defense satellite)
            _super.call(this, 1, 21) || this;
        ...
        DefSat.prototype.run = function (x) {
            ...
            launchScoutButton.click(function (e) { launchScout(); scoutContainer.remove(); });
            /*
...
//# sourceMappingURL=DefenseSat.js.map