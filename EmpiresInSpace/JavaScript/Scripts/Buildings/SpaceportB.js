...
var Scripts;
(function (Scripts) {
    var Spaceport = /** @class */ (function (_super) {
        __extends(Spaceport, _super);
        function Spaceport() {
            var _this = _super.call(this, 1, 17) || this;
            _this.scriptHeader = i18n.label(119);
            _this.moduleView = true;
            //call super, set scriptType to 1 (Building) and Id to 17 (Spaceport)
            _this.run();
            return _this;
        }
        Spaceport.prototype.run = function () {
            var _this = this;
            ...
            buttonSwitch.click(function (e) {
                ...
                _this.moduleView = !_this.moduleView;
                _this.refreshAll();
                _this.setSwitchLabel();
            });
            ...
            $('.noButton', this.spacePortPopup).click(function (e) {
                //Scripts.scriptsAdmin.loadAndRun(3, 1, 'ShipTemplateDesigner.js');
                Scripts.scriptsAdmin.loadAndRun(3, 1, './ShipTemplateDesigner.js', false, function () { ShipTemplateDesigner.runTemplate(null); });
                //questContainer.remove();
                _this.windowHandle.remove();
            });
        ...
        Spaceport.prototype.refreshAll = function () {
            ...
            for (var i = 0; i < ShipTemplateModule.shipTemplates.length; i++) {
                if (ShipTemplateModule.shipTemplates[i] == null) { /*Helpers.Log("null");*/
                    continue;
                }
                if (!ShipTemplateModule.shipTemplates[i].constructable)
                    continue;
                if (ShipTemplateModule.shipTemplates[i].obsolete)
                    continue;
                if (!PlayerData.hullsAvailable(ShipTemplateModule.shipTemplates[i].shipHullId))
                    continue;
        ...
        Spaceport.prototype.setSwitchLabel = function () {
            if (this.moduleView)
        ...
        */
        Spaceport.prototype.createTableHeader = function () {
            var tableRow = $('<tr/>');
        ...
        Spaceport.prototype.shipTemplateLine2 = function (_caller, shipTemplate) {
            var _this = this;
            var tableRow = $('<tr/>');
            ...
            //from hull
            if (this.moduleView) {
                var costs = BaseDataModule.shipHulls[shipTemplate.shipHullId].costs;
                //from ship Hull
                for (var goodsIndex = 0; goodsIndex < costs.length; goodsIndex++) {
                    ...
                    var borderColor;
                    borderColor = null;
                    if (mainObject.currentColony.goods[goodsIndex] == null)
                        borderColor = "borderColorRed";
                    if (costs[goodsIndex] > mainObject.currentColony.goods[goodsIndex])
                        borderColor = "borderColorRed";
                ...
                for (var moduleIndex = 0; moduleIndex < shipTemplate.modulePositions.length; moduleIndex++) {
                    if (shipTemplate.modulePositions[moduleIndex] == null)
                        continue;
            ...
            */
            tableRow.click(function (e) { _this.spacePortBuildClicked(shipTemplate, true); });
            return tableRow;
        };
        Spaceport.prototype.showError = function (msg) {
        ...
        Spaceport.prototype.spacePortBuildClicked = function (shipTemplate, build) {
        ...
        Spaceport.prototype.isEnemyInOrbit = function () {
