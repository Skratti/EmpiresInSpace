...
(function (Ships) {
    ...
    var shipCosts;
    var selectedShip;
    var shipDetailPanel = /** @class */ (function (_super) {
        __extends(shipDetailPanel, _super);
        function shipDetailPanel() {
            var _this = 
            //call super, set scriptType to 4(Details) and Id to 1 (Ship-Details)
            _super.call(this, 4, 1) || this;
            Scripts.scriptsAdmin.scripts.push(_this);
            _this.run();
            return _this;
        }
        shipDetailPanel.prototype.run = function () {
            showDetailPanel();
        };
    ...
    function showDetailPanel() {
        ...
        Ships.detailsContainer = _DesignerContainer;
        var panelHeader = $('.relPopupHeader', Ships.detailsContainer);
        var caption = $('<h2/>', { text: i18n.label(205), style: "float:left" });
        panelHeader.append(caption);
        var panelBody = $('.relPopupBody', Ships.detailsContainer);
        ...
        $('.noButton', Ships.detailsContainer)[0].style.display = 'none';
        //$('.noButton', detailsContainer).text('Selbstzerstörung');
        $('.yesButton span', Ships.detailsContainer).text(i18n.label(206)); // Selbstzerstörung
        //spaceportContainer.tooltip();
        Ships.detailsContainer.appendTo("body"); //attach to the <body> element
        ...
        $('.yesButton', Ships.detailsContainer).click(function (e) { Ships.detailsContainer.remove(); });
    ...
    function refreshStatistics() {
        ...
        engineTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(212) })).append($("<td/>", { text: selectedShip.systemMovesPerTurn })) //System drive
        ));
        engineTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(213) })).append($("<td/>", { text: selectedShip.galaxyMovesPerTurn })) //Star drive
        ));
        engineTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(214) })).append($("<td/>", { text: selectedShip.systemMovesMax })) //System battery
        ));
        engineTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(215) })).append($("<td/>", { text: selectedShip.galaxyMovesMax })) //Star battery
        ));
        statDrive.append(engineTable);
        //statWar : attack, defense, HP, SHield...
        var warTable = $("<table/>");
        warTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(216) })).append($("<td/>", { text: selectedShip.attack })) //Angriff
        ));
        warTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(217) })).append($("<td/>", { text: selectedShip.defense })) //Verteidigung
        ));
        warTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(218) })).append($("<td/>", { text: selectedShip.hitpoints })) //Trefferpunkte
        ));
        warTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(219) })).append($("<td/>", { text: selectedShip.damagereduction })) //Schilde
        ));
        ...
        specialTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(220) })).append($("<td/>", { text: selectedShip.cargoroom })) //Lagerraum
        ));
        specialTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(221) })).append($("<td/>", { text: selectedShip.fuelroom })) //Tank
        ));
        specialTable.append(($("<tr/>").append($("<td/>", { text: i18n.label(222) })).append($("<td/>", { text: selectedShip.scanRange })) //Scanner
        ));
    ...
    function insertModuleDiv(parent, shipModule, targetPosition) {
        parent.empty();
    ...
    Ships.insertModuleDiv = insertModuleDiv;
...
//# sourceMappingURL=ShipDetails.js.map